...
const cuttweet = [
  'كت تويت | اذا كان شي واحد ترسمه ويصير حقيقي وش هو؟',
  'كت تويت | أكثر شيء يُسكِت الطفل برأيك؟',
  'كت تويت | لو عندك امنية وحدة وش تبيها؟',
  'كت تويت | قناة الكرتون المفضلة في طفولتك؟',
  'كت تويت | لعبتك المفضلة؟',
  'كت تويت | عيب بك ودك تصلحه؟',
  'كت تويت | موقف صار معك ما تنساه؟',
  'كت تويت | لو ترجع صغير وش بتسوي؟',
  '  كت تويت | أحلى هدية جاتك ومن من؟ ',
  'كت تويت | مِن أغرب وأجمل الأسماء التي مرت عليك؟',
  'كت تويت | أكثر سؤال يقهرك؟',
  'كت تويت | أكثر سؤال وجِّه إليك مؤخرًا؟',
  'كت تويت | ما هو الشيء الذي يجعلك تشعر بالخوف؟',
  'كت تويت | أكثر لعبة تحس انها اشتهرت ذي الفترة؟',
  ...
  'كت تويت | أكثر شخص يعصب بك؟',
  'كت تويت | أكثر تطبيق تستخدمه مؤخرًا؟',
  'كت تويت | هدية ودك فيها؟',
  'كت تويت | وش محتاج عشان تكون مبسوط ؟',
  'كت تويت | أسخف كذبة مشت عليك ومن من؟',
  'كت تويت | هل قد أفطرت برمضان؟',
]

client.on('message', message => {
	var prefix = "M"
if (message.content.startsWith(prefix + "كت تويت")) {
             if(!message.channel.guild) return message.reply('** العب بالسيرفر مو عندي:unamused: :innocent:**');
var embed = new Discord.RichEmbed()
.setColor('#00ff47')
.setThumbnail(message.author.avatarURL)
.addField('M Games' ,
